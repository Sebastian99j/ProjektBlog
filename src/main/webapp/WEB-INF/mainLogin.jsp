    ...
    <div style="padding: 20px;">
        <fieldset>
            ...
            <div style="margin-top: 10px; text-align: center;">
                <input class="xbutton" type="button" value="Zarejestruj się" onClick="location.href='${pageContext.request.contextPath}/registration';"/>
            </div>
            <div style="margin-top: 10px; text-align: center;">
                <input class="xbutton" type="button" value="Zaloguj się" onClick="location.href='${pageContext.request.contextPath}/login';"/>
            </div>
            <div style="margin-top: 10px;  text-align: center;">
